...
<body style = "background-color: violet">
    ...
    <div class="container mt-4">
        ...
        <div class="carousel-inner">
            ...
            <img src="..\resources\pic1.jpg" class="d-block w-100" alt="..." style = "width: 50px; height: 580px;">
            </div>
            <div class="carousel-item">
            <img src="../resources/pic2.jpg" class="d-block w-100" alt="..." style = "width: 50px; height: 580px;">
            </div>
            <div class="carousel-item">
            <img src="../resources/pic3.jpg" class="d-block w-100" alt="..." style = "width: 50px; height: 580px;">
            </div>
            <div class="carousel-item">
            <img src="../resources/pic4.jpg" class="d-block w-100" alt="..." style = "width: 50px; height: 580px;">
            </div>
        </div>
