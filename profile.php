...
<body style = "background-color: violet">
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h2 class="mb-4"><b>ADMIN PROFILE</b></h2>
                <div class="card">
                            ...
                            <div class="mb-3">
                             ...
                             <div class="card mt-3">
                                <div class="card-header bg-primary bg-gradient text-white">
                                    <h5 class="text-center">Amount of Money</h5>
                                </div>
                                <div class="card-body">
                                    <p class="text-center">Amount of Money: $<?php echo htmlspecialchars($admin_data['amount_of_money']); ?></p>
                                </div>
                            </div>
