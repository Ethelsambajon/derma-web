        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id=" . $product_id); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select name="category" class="form-control">
                    <option value="Moisturizer" <?php if ($row['category'] === 'Moisturizer') echo 'selected'; ?>>Moisturizer</option>
                    <option value="Soap" <?php if ($row['category'] === 'Soap') echo 'selected'; ?>>Soap</option>
                    <option value="Sun screen" <?php if ($row['category'] === 'Sun screen') echo 'selected'; ?>>Sun screen</option>
                </select>
            </div>
